...
void main()
{
		...
		/* Here we hold the names of the watched files, indexed by 
		...
		while(1)
		{
				...
				/* Loop over all events and report them. This is a little tricky because the event records are not of fixed length */
