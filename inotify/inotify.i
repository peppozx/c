...
# 82 "/usr/include/x86_64-linux-gnu/sys/inotify.h" 3 4
...
# 19 "inotify.c"
  ...
  char eventbuf[(100 * (sizeof(struct inotify_event) + 
# 22 "inotify.c" 3 4
               255 
# 22 "inotify.c"
               + 1))];
...
# 29 "inotify.c"
  ...
  if ((fconfig = fopen("monitor.conf", "r")) == 
# 34 "inotify.c" 3 4
                                               ((void *)0)
# 34 "inotify.c"
                                                   )
...
# 52 "inotify.c"
  ...
  while(1)
  {
    n = read(notifyfd, eventbuf, (100 * (sizeof(struct inotify_event) + 
# 70 "inotify.c" 3 4
                                255 
# 70 "inotify.c"
                                + 1)));
