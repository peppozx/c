...
# 3 "exit-status-demo.c" 2



# 5 "exit-status-demo.c"
int main()
{
    int status;
    if (fork())
    {
        ...
        wait(&status);
        if (
# 13 "exit-status-demo.c" 3 4
           (((
# 13 "exit-status-demo.c"
           status
# 13 "exit-status-demo.c" 3 4
           ) & 0x7f) == 0)
# 13 "exit-status-demo.c"
...
# 15 "exit-status-demo.c" 3 4
                                                              (((
# 15 "exit-status-demo.c"
                                                              status
# 15 "exit-status-demo.c" 3 4
                                                              ) & 0xff00) >> 8)
# 15 "exit-status-demo.c"
        ...
        if (
# 17 "exit-status-demo.c" 3 4
           (((signed char) (((
# 17 "exit-status-demo.c"
           status
# 17 "exit-status-demo.c" 3 4
           ) & 0x7f) + 1) >> 1) > 0)
# 17 "exit-status-demo.c"
...
# 19 "exit-status-demo.c" 3 4
                                                     ((
# 19 "exit-status-demo.c"
                                                     status
# 19 "exit-status-demo.c" 3 4
                                                     ) & 0x7f)
# 19 "exit-status-demo.c"
        ...
        if (fork())
            {
                ...
                wait(&status2);
                if (
# 31 "exit-status-demo.c" 3 4
                   (((
# 31 "exit-status-demo.c"
                   status2
# 31 "exit-status-demo.c" 3 4
                   ) & 0x7f) == 0)
# 31 "exit-status-demo.c"
...
# 33 "exit-status-demo.c" 3 4
                                                                            (((
# 33 "exit-status-demo.c"
                                                                            status2
# 33 "exit-status-demo.c" 3 4
                                                                            ) & 0xff00) >> 8)
# 33 "exit-status-demo.c"
                ...
                if (
# 35 "exit-status-demo.c" 3 4
                   (((signed char) (((
# 35 "exit-status-demo.c"
                   status2
# 35 "exit-status-demo.c" 3 4
                   ) & 0x7f) + 1) >> 1) > 0)
# 35 "exit-status-demo.c"
                ...
                {
                    printf("child terminated by signal %d\n", 
# 37 "exit-status-demo.c" 3 4
                                                             ((
# 37 "exit-status-demo.c"
                                                             status2
# 37 "exit-status-demo.c" 3 4
                                                             ) & 0x7f)
# 37 "exit-status-demo.c"
